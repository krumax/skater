...
- [x] 1. Supabase-Abhängigkeit installieren und Client einrichten
...
- [x] 2. Datenbankschema in Supabase anlegen
  - [x] 2.1 SQL-Migrationsskript ausführen
...
- [x] 3. Sync-Service implementieren
  - [x] 3.1 `src/lib/syncService.js` erstellen mit `createSession`-Funktion
  ...
  - [x] 3.2 `loadSession`-Funktion implementieren
  ...
  - [x] 3.4 `insertRound`-Funktion implementieren
  ...
  - [x] 3.5 Property-Test für Runden-Persistenz-Round-Trip schreiben
...
- [x] 4. GameContext erweitern
  - [x] 4.1 `LOAD_SESSION`-Reducer-Case hinzufügen
  ...
  - [x] 4.2 `syncStatus`-State und Initialisierungslogik implementieren
  ...
  - [x] 4.4 `addRound` mit Sync-Service verdrahten
...
- [x] 6. Sidebar erweitern
  ...
  - [x] 6.3 Render-Tests für Sidebar schreiben
...
- [x] 7. Finaler Checkpoint – Alle Tests ausführen und Integration prüfen
  - Sicherstellen, dass alle Tests bestehen. Bei Fragen oder Problemen den Benutzer informieren.
